...
from clip.model_LORA import build_model_LORA
...
def load(name: str, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", jit=True, is_train=False, pretrained=True, args=None):
    """Load a CLIP model
    Parameters
    ----------
    name : str
